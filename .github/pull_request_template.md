...
- [ ] If reference chapters changed, `/docs/book/reference_index.md` is still synchronized.
- [ ] New or edited examples are parseable/runnable, or explicitly marked with `DOCS-EXAMPLE-OPT-OUT: <reason>`.
- [ ] Public CLI flag changes are reflected in `/docs/development.md` and relevant impl docs.
