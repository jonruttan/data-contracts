  ...
  config:
    ...
    - as: domain.repo.walk_matching
      ...
      - id: domain.repo.walk_matching.doc.1
        ...
        status: active
        description: |-
          Purpose: This entry documents behavior for `domain.repo.walk_matching` for the declared audience, including input expectations, output contracts, and failure modes.
