...
harness:
  ...
  config:
    ...
    - as: php.is_assoc_projection
      ...
      - id: php.is_assoc_projection.doc.1
        ...
        status: active
        description: |-
          Purpose: Documents behavior of `php.is_assoc_projection` for this audience, including expected inputs, return shape, failure modes, and practical use cases.
        ...
        - Use this for implementation work, local debugging, and runner-side behavior
          analysis.
      - id: php.is_assoc_projection.doc.1.operator
        ...
        usage_context:
        - Use this for observability, runbook readiness, and incident response.
      - id: php.is_assoc_projection.doc.1.integrator
        summary: Contract export for `php.is_assoc_projection`. (integrator)
        audience: integrator
        status: active
        description: |-
          Purpose: Documents behavior of `php.is_assoc_projection` for this audience, including expected inputs, return shape, failure modes, and practical use cases.
        ...
        usage_context:
        - Use this for composing this contract in pipelines, services, and toolchains.
      - id: php.is_assoc_projection.doc.1.maintainer
        summary: Contract export for `php.is_assoc_projection`. (maintainer)
        audience: maintainer
        status: active
        description: |-
          Purpose: Documents behavior of `php.is_assoc_projection` for this audience, including expected inputs, return shape, failure modes, and practical use cases.
        ...
        usage_context:
        - Use this for versioning, changelogs, and stability planning.
      - id: php.is_assoc_projection.doc.1.governance
        ...
        usage_context:
        - Use this for policy gating, approval review, and compliance checks.
      - id: php.is_assoc_projection.doc.1.reviewer
        ...
        usage_context:
        - Use this to verify correctness, completeness, and release readiness.
      - id: php.is_assoc_projection.doc.1.auditor
  ...
  - id: LIB-DOMAIN-PHP-001
    ...
    - summary: Case `LIB-DOMAIN-PHP-001` for `contract.export`. (auditor)
      ...
      - Use this as documented evidence for audit and policy review.
adapters:
- type: beta.exports_as_php_is_assoc_projection_from_assert_function_path_export_php_is_assoc_projection_params_subject_required_true_docs_id_php_is_assoc_projection_doc_1_summary_contract_export_for_php_is_assoc_projection_audience_spec_authors_status_active_description_auto_generated_metadata_stub_replace_with_authored_reference_text_n_nprior_doc_fields_migrated_to_description_n_examples_title_basic_usage_ninput_n_subject_subject_nexpected_result_nnotes_replace_with_a_concrete_scenario_n_params_name_subject_n_type_any_n_required_true_n_description_input_parameter_subject_n_returns_type_any_ndescription_result_payload_for_this_symbol_n_errors_code_schema_error_n_when_input_payload_does_not_satisfy_contract_shape_requirements_n_category_schema_n_portability_python_true_nphp_true_nrust_true_nnotes_confirm_per_runtime_behavior_and_caveats_since_v1
  actions:
  - id: act.lib.php.core.spec.1
    direction: bidirectional
    profile: default
services:
- id: svc.lib.php.core.spec.1
  consumes:
  - act.lib.php.core.spec.1
```
