  ...
  config:
    ...
    - as: py.is_tuple_projection
      ...
      - id: py.is_tuple_projection.doc.1
        ...
        status: active
        description: |-
          Purpose: This entry documents behavior for `py.is_tuple_projection` for the declared audience, including input expectations, output contracts, and failure modes.
