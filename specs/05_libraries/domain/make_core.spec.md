...
harness:
  ...
  config:
    ...
    - as: make.has_target
      ...
      - id: make.has_target.doc.1
        ...
        status: active
        description: |-
          Purpose: This entry documents behavior for `make.has_target` for the declared audience, including input expectations, output contracts, and failure modes.
  ...
  - id: LIB-DOMAIN-MAKE-001
    ...
    - summary: Case `LIB-DOMAIN-MAKE-001` for `contract.export`. (integrator)
      ...
      tags:
      - domain
      id: domain.make.core.integrator
      module: domain
      stability: alpha
      owner: data-contracts
      inputs:
    ...
    - summary: Case `LIB-DOMAIN-MAKE-001` for `contract.export`. (maintainer)
      ...
      tags:
      - domain
      id: domain.make.core.maintainer
      module: domain
      stability: alpha
      owner: data-contracts
      inputs:
    ...
    - summary: Case `LIB-DOMAIN-MAKE-001` for `contract.export`. (governance)
      ...
      tags:
      - domain
      id: domain.make.core.governance
      module: domain
      stability: alpha
      owner: data-contracts
      inputs:
