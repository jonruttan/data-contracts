  ...
  config:
    ...
    - as: domain.process.exec_capture_ex_code
      ...
      - id: domain.process.exec_capture_ex_code.doc.1
        ...
        status: active
        description: |-
          Purpose: Documents behavior of `domain.process.exec_capture_ex_code` for this audience, including expected inputs, return shape, failure modes, and practical use cases.
