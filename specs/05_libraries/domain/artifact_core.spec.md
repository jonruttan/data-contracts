  ...
  config:
    ...
    - as: domain.artifact.write_yaml
      ...
      - id: domain.artifact.write_yaml.doc.1
        ...
        status: active
        description: |-
          Purpose: Documents behavior of `domain.artifact.write_yaml` for this audience, including expected inputs, return shape, failure modes, and practical use cases.
