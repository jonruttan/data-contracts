  ...
  config:
    ...
    - as: domain.meta.has_artifact_target
      ...
      - id: domain.meta.has_artifact_target.doc.1
        ...
        status: active
        description: |-
          Purpose: Documents behavior of `domain.meta.has_artifact_target` for this audience, including expected inputs, return shape, failure modes, and practical use cases.
