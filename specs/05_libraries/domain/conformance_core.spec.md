  ...
  config:
    ...
    - as: domain.conformance.validate_report_errors
      ...
      - id: domain.conformance.validate_report_errors.doc.1
        ...
        status: active
        description: |-
          Purpose: Documents behavior of `domain.conformance.validate_report_errors` for this audience, including expected inputs, return shape, failure modes, and practical use cases.
