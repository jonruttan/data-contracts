  ...
  config:
    ...
    - as: domain.contract_set.id
      ...
      - id: domain.contract_set.applies_to_runners.doc.1
        ...
        status: active
        description: |-
          Purpose: This entry documents behavior for `domain.contract_set.applies_to_runners` for the declared audience, including input expectations, output contracts, and failure modes.
