  ...
  config:
    ...
    - as: domain.path.sorted
      ...
      - id: domain.path.sorted.doc.1
        ...
        status: active
        description: |-
          Purpose: This entry documents behavior for `domain.path.sorted` for the declared audience, including input expectations, output contracts, and failure modes.
