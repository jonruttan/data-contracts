  ...
  config:
    ...
    - as: policy.pass_when_no_violations
      ...
      - id: policy.violation_count_is.doc.1
        ...
        status: active
        description: |-
          Purpose: Documents behavior of `policy.violation_count_is` for this audience, including expected inputs, return shape, failure modes, and practical use cases.
