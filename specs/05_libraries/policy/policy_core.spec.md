  ...
  config:
    ...
    - as: policy.pass_when_no_violations
      ...
      - id: policy.violation_count_is.doc.1
        ...
        status: active
        description: |-
          Purpose: This entry documents behavior for `policy.violation_count_is` for the declared audience, including input expectations, output contracts, and failure modes.
