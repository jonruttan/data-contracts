...
harness:
  ...
  config:
    ...
    - '{''exports'': [{''as'': ''make.has_target'', ''from'': ''assert.function'',
      ''path'': ''/__export__make.has_target'', ''params'': [''subject'', ''target''],
      ''required'': True, ''docs'': [{''id'': ''make.has_target.doc.1'', ''summary'':
      ''Contract export for `make.has_target`.'', ''audience'': ''spec-authors'',
