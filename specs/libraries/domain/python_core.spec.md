...
harness:
  ...
  config:
    ...
    - '{''exports'': [{''as'': ''py.is_tuple_projection'', ''from'': ''assert.function'',
      ''path'': ''/__export__py.is_tuple_projection'', ''params'': [''subject''],
      ''required'': True, ''docs'': [{''id'': ''py.is_tuple_projection.doc.1'', ''summary'':
      ''Contract export for `py.is_tuple_projection`.'', ''audience'': ''spec-authors'',
