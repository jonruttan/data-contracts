...
services:
  ...
  - id: 
    ...
    type: 
      legacy.check_profile_text_file_config_use_ref_lib_policy_text_001_as_lib_policy_text_symbols_policy_text_contains_all_policy_text_contains_none_policy_text_contains_pair
```
