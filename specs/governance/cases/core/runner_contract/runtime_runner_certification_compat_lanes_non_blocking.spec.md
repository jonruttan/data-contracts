...
- id: DCGOV-RUNTIME-CERT-005
  ...
  purpose: Ensures compatibility lanes are classified and emitted as 
    non-blocking in certification artifacts.
  clauses:
    imports:
    - from: artifact
      names:
...
services:
  ...
  - id: 
    ...
    type: 
      legacy.root_check_profile_governance_scan_config_check_runtime_runner_certification_compat_lanes_non_blocking
    io: io
    profile: default
    config: {}
    default: true
