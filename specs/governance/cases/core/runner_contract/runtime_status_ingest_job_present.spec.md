...
services:
  ...
  - id: 
    ...
    type: 
      legacy.root_ci_ingest_job_path_github_workflows_ci_yml_required_tokens_runner_status_ingest_none_scripts_runner_status_ingest_sh_max_age_hours_72_enforce_freshness_check_profile_governance_scan_config_check_runtime_status_ingest_job_present
    io: io
    profile: default
    config: {}
    default: true
