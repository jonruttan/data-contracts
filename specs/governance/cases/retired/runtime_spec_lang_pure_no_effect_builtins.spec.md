...
harness:
  ...
  config:
    ...
    - "{'root': '.', 'spec_lang_purity': {'files': ['dc-runner-python', 'dc-runner-php', 'dc-runner-php'], 'forbidden_tokens': ['path_exists']}, 'check': {'profile': 'governance.scan', 'config': {'check': 'runtime.spec_lang_pure_no_effect_builtins'}}, 'use': [{'ref': '/specs/libraries/policy/policy_core.spec.md', 'as': 'lib_policy_core_spec', 'symbols': ['policy.pass_when_no_violations']}]}"
services:
  actions:
