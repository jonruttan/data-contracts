...
harness:
  ...
  config:
    ...
    - "{'root': '.', 'public_docs': {'files': ['/README.md', '/docs/development.md', '/specs/current.md', '/specs/contract/12_runner_interface.md'], 'forbidden_tokens': ['dc-runner-rust'], 'allowlist': ['/specs/contract/12_runner_interface.md']}, 'check': {'profile': 'governance.scan', 'config': {'check': 'runtime.no_public_direct_rust_adapter_docs'}}, 'use': [{'ref': '/specs/libraries/policy/policy_core.spec.md', 'as': 'lib_policy_core_spec', 'symbols': ['policy.pass_when_no_violations']}]}"
services:
  entries:
