...
- defaults and runtime profiles are configured in `specs/03_conformance/purpose_lint_v1.yaml`
...
- canonical warning code definitions live in `specs/03_conformance/purpose_warning_codes.md`
