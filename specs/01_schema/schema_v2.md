...
- `specs/01_schema/docs_schema_v2.md`
- `specs/01_schema/reference_manifest_v2.md`
- `specs/01_schema/objective_metrics_schema_v2.md`
- `specs/01_schema/docs_generator_registry_v2.yaml`
- `specs/01_schema/docs_layout_profile_v2.yaml`
- `specs/01_schema/runner_api_catalog_v2.yaml`
- `specs/01_schema/harness_type_catalog_v2.yaml`
- `specs/01_schema/spec_lang_builtin_catalog_v2.yaml`
- `specs/01_schema/spec_lang_stdlib_profile_v2.yaml`
- `specs/01_schema/subject_profiles_v2.yaml`
- `specs/01_schema/run_trace_v2.yaml`
- `specs/01_schema/orchestration_result_v2.yaml`
- `specs/01_schema/registry_schema_v2.yaml`
- `specs/01_schema/registry/v2/*.yaml`
- `specs/02_contracts/19_spec_lang_stdlib_profile_v2.md`
- `specs/02_contracts/20_subject_profiles_v2.md`
...
- Machine source of truth for case-shape constraints lives in
  `specs/01_schema/registry/v2/*.yaml`; this document includes a generated
...
- `/specs/01_schema/registry/v2/core.yaml and /specs/01_schema/registry/v2/assertions.yaml` defines compact/short alias
...
- binding shape/alias grammar source:
  `/specs/01_schema/registry/v2/core.yaml and /specs/01_schema/registry/v2/assertions.yaml`
...
- spec-lang semantics and budget model are defined in
  `specs/02_contracts/03b_spec_lang_v2.md`
...
- regex portability guidance for spec-lang expressions is defined in
  `specs/02_contracts/03a_regex_portability_v2.md`
...
This section is generated from `specs/01_schema/registry/v2/*.yaml`.
