...
harness:
  ...
  config:
    ...
    - "{'root': '.', 'public_docs': {'files': ['/README.md', '/docs/development.md', '/specs/current.md', '/specs/02_contracts/12_runner_interface.md'], 'forbidden_tokens': ['dc-runner-rust'], 'allowlist': ['/specs/02_contracts/12_runner_interface.md']}, 'check': {'profile': 'governance.scan', 'config': {'check': 'runtime.no_public_direct_rust_adapter_docs'}}, 'use': [{'ref': '/specs/05_libraries/policy/policy_core.spec.md', 'as': 'lib_policy_core_spec', 'symbols': ['policy.pass_when_no_violations']}]}"
services:
  actions:
  - id: svc.root_public_docs_files_readme_md_docs_development_md_specs_current_md_specs_contract_12_runner_interface_md_forbidden_tokens_dc_runner_rust_allowlist_specs_contract_12_runner_interface_md_check_profile_governance_scan_config_check_runtime_no_public_direct_rust_adapter_docs_use_ref_specs_libraries_policy_policy_core_spec_md_as_lib_policy_core_spec_symbols_policy_pass_when_no_violations.default.1
