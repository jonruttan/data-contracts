...
harness:
  ...
  config:
    ...
    - "{'root': '.', 'rust_subcommand_parity': {'adapter_path': '/dc-runner-rust', 'cli_main_path': '/dc-runner-rust'}, 'check': {'profile': 'governance.scan', 'config': {'check': 'runtime.required_lane_adapter_subcommand_parity'}}, 'use': [{'ref': '/specs/05_libraries/policy/policy_core.spec.md', 'as': 'lib_policy_core_spec', 'symbols': ['policy.pass_when_no_violations']}]}"
services:
  actions:
