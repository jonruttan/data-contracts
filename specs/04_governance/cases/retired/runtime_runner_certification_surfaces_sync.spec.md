...
harness:
  ...
  config:
    ...
    - "{'root': '.', 'runner_certification_surfaces': {'files': ['/dc-runner-rust', '/dc-runner-rust', '/specs/04_governance/cases/core/runtime_runner_interface_subcommands.spec.md'], 'required_tokens': ['runner-certify']}, 'check': {'profile': 'governance.scan', 'config': {'check': 'runtime.runner_certification_surfaces_sync'}}}"
services:
  actions:
