...
harness:
  ...
  config:
    ...
    - "{'root': '.', 'runner_status_matrix_schema': {'path': '/specs/01_schema/runner_status_matrix_v1.yaml', 'required_tokens': [{'type': 'runtime.runner_status_matrix'}, 'matrix_rows', 'freshness_state', 'policy_effect']}, 'check': {'profile': 'governance.scan', 'config': {'check': 'runtime.runner_status_matrix_schema_valid'}}}"
contracts:
  clauses:
