...
harness:
  ...
  config:
    ...
    - "{'root': '.', 'spec_lang_fixture_library_usage': {'path': '/specs/03_conformance/cases/core/spec_lang.spec.md', 'required_library_path': '/specs/05_libraries/conformance/assertion_core.spec.md', 'required_call_prefix': 'conf.', 'min_call_count': 4, 'required_case_ids': ['DCCONF-EXPR-001', 'DCCONF-EXPR-002', 'DCCONF-EXPR-008']}, 'check': {'profile': 'governance.scan', 'config': {'check': 'conformance.spec_lang_fixture_library_usage'}}, 'use': [{'ref': '/specs/05_libraries/policy/policy_assertions.spec.md', 'as': 'lib_policy_core_spec', 'symbols': ['policy.assert.no_violations', 'policy.assert.summary_passed', 'policy.assert.summary_check_id', 'policy.assert.scan_pass']}]}"
contracts:
  clauses:
