...
harness:
  ...
  config:
    ...
    - "{'root': '.', 'objective_scorecard_non_regression': {'baseline_path': '/specs/04_governance/metrics/objective_scorecard_baseline.json', 'summary_fields': {'overall_min_score': 'non_decrease', 'overall_mean_score': 'non_decrease', 'tripwire_hit_count': 'non_increase'}, 'epsilon': 1e-12, 'objective_scorecard': {'manifest_path': '/specs/04_governance/metrics/objective_manifest.yaml'}, 'baseline_notes': {'path': '/specs/04_governance/metrics/baseline_update_notes.yaml', 'baseline_paths': ['/specs/04_governance/metrics/spec_portability_baseline.json', '/specs/04_governance/metrics/spec_lang_adoption_baseline.json', '/specs/04_governance/metrics/runner_independence_baseline.json', '/specs/04_governance/metrics/docs_operability_baseline.json', '/specs/04_governance/metrics/contract_assertions_baseline.json', '/specs/04_governance/metrics/objective_scorecard_baseline.json']}}, 'check': {'profile': 'governance.scan', 'config': {'check': 'objective.scorecard_non_regression'}}, 'use': [{'ref': '/specs/05_libraries/policy/policy_assertions.spec.md', 'as': 'lib_policy_core_spec', 'symbols': ['policy.assert.no_violations', 'policy.assert.summary_passed', 'policy.assert.summary_check_id', 'policy.assert.scan_pass']}]}"
contracts:
  clauses:
