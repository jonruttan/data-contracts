...
- `docs/spec/contract/policy_v1.yaml` (`MUST` / `SHOULD` / `MUST_NOT`)
- `docs/spec/contract/traceability_v1.yaml` (rule -> evidence mapping)
- `docs/spec/contract/rule_template.md` (authoring template)

Read in order:

1. `docs/spec/contract/00_design_goals.md`
2. `docs/spec/contract/versioning.md`
3. `docs/spec/contract/01_discovery.md`
