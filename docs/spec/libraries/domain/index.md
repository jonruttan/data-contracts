...
- `domain.conformance.error_when_false` (/docs/spec/libraries/domain/conformance_core.spec.md)
- `domain.conformance.report_results_is_list` (/docs/spec/libraries/domain/conformance_core.spec.md)
- `domain.conformance.report_version_is_v1` (/docs/spec/libraries/domain/conformance_core.spec.md)
