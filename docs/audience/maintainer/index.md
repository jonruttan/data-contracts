...
### implicit_ids_v1.doc.1.1.maintainer
...
### schema_case_validation.doc.1.1.maintainer
...
### schema_case_validation.doc.2.1.maintainer
- Location: `/specs/03_conformance/cases/core/schema_case_validation.spec.md`
...
### schema_case_validation.doc.3.1.maintainer
- Location: `/specs/03_conformance/cases/core/schema_case_validation.spec.md`
...
### schema_case_validation.doc.4.1.maintainer
- Location: `/specs/03_conformance/cases/core/schema_case_validation.spec.md`
...
### schema_case_validation.doc.5.1.maintainer
- Location: `/specs/03_conformance/cases/core/schema_case_validation.spec.md`
...
### schema_case_validation.doc.5.2.maintainer
- Location: `/specs/03_conformance/cases/core/schema_case_validation.spec.md`
...
### schema_case_validation.doc.6.1.maintainer
- Location: `/specs/03_conformance/cases/core/schema_case_validation.spec.md`
...
### schema_case_validation.doc.9.1.maintainer
- Location: `/specs/03_conformance/cases/core/schema_case_validation.spec.md`
...
### schema_case_validation.doc.11.1.maintainer
- Location: `/specs/03_conformance/cases/core/schema_case_validation.spec.md`
...
### conf.json_type_is.doc.1.maintainer
...
### conformance.assertion.core.maintainer
- Location: `/specs/05_libraries/conformance/assertion_core.spec.md`
...
### bad.path.symbol.doc.1.maintainer
...
### conformance.chain.export.validation.maintainer
- Location: `/specs/05_libraries/conformance/chain_export_validation.spec.md`
...
### domain.artifact.write_yaml.doc.1.maintainer
...
### domain.artifact.core.maintainer
- Location: `/specs/05_libraries/domain/artifact_core.spec.md`
- Summary: Case `LIB-DOMAIN-ARTIFACT-001-001-DOMAIN-ARTIFACT-WRITE-YAML` for `contract.export`. (maintainer)
- Description:
  Purpose: Documents behavior for `domain.artifact.write_yaml` for this audience, including input contract, output contract, and failure modes.
...
### domain.conformance.validate_report_errors.doc.1.maintainer
...
### domain.conformance.core.maintainer
- Location: `/specs/05_libraries/domain/conformance_core.spec.md`
- Summary: Case `LIB-DOMAIN-CONFORMANCE-001-000-DOMAIN-CONFORMANCE-ERROR-WHEN-FALSE` for `contract.export`. (maintainer)
- Description:
  Purpose: Documents behavior for `domain.conformance.validate_report_errors` for this audience, including input contract, output contract, and failure modes.
...
### domain.contract_set.applies_to_runners.doc.1.maintainer
...
### domain.contract_set.core.maintainer
- Location: `/specs/05_libraries/domain/contract_set_core.spec.md`
...
### domain.fs.sort_spec_files.doc.1.maintainer
...
### domain.fs.core.maintainer
- Location: `/specs/05_libraries/domain/fs_core.spec.md`
- Summary: Case `LIB-DOMAIN-FS-001-001-DOMAIN-FS-IS-DOCS-SPEC-FILE` for `contract.export`. (maintainer)
- Description:
  Purpose: Documents behavior for `domain.fs.sort_spec_files` for this audience, including input contract, output contract, and failure modes.
...
### domain.http.step_status_is.doc.1.maintainer
...
### domain.http.core.maintainer
- Location: `/specs/05_libraries/domain/http_core.spec.md`
- Summary: Case `LIB-DOMAIN-HTTP-001-001-DOMAIN-HTTP-STATUS` for `contract.export`. (maintainer)
- Description:
  Purpose: Documents behavior for `domain.http.step_status_is` for this audience, including input contract, output contract, and failure modes.
...
### domain.job.scan_bundle_has_result.doc.1.maintainer
...
### domain.job.core.maintainer
- Location: `/specs/05_libraries/domain/job_core.spec.md`
- Summary: Case `LIB-DOMAIN-JOB-001-000A-DOMAIN-JOB-SCAN-BUNDLE-HAS-RESULT` for `contract.export`. (maintainer)
- Description:
  Purpose: Documents behavior for `domain.job.scan_bundle_has_result` for this audience, including input contract, output contract, and failure modes.
...
### make.has_target.doc.1.maintainer
...
### domain.make.core.maintainer
- Location: `/specs/05_libraries/domain/make_core.spec.md`
- Summary: Case `LIB-DOMAIN-MAKE-001` for `contract.export`. (maintainer)
- Description:
  Purpose: Documents behavior for `make.has_target` for this audience, including input contract, output contract, and failure modes.
...
### domain.markdown.tokens_all_present.doc.1.maintainer
...
### domain.markdown.core.maintainer
- Location: `/specs/05_libraries/domain/markdown_core.spec.md`
- Summary: Case `LIB-DOMAIN-MD-001-001-DOMAIN-MARKDOWN-HAS-HEADING` for `contract.export`. (maintainer)
- Description:
  Purpose: Documents behavior for `domain.markdown.tokens_all_present` for this audience, including input contract, output contract, and failure modes.
...
### domain.meta.has_artifact_target.doc.1.maintainer
...
### domain.meta.core.maintainer
- Location: `/specs/05_libraries/domain/meta_core.spec.md`
- Summary: Case `LIB-DOMAIN-META-001-001-DOMAIN-META-CASE-ID-EQ` for `contract.export`. (maintainer)
- Description:
  Purpose: Documents behavior for `domain.meta.has_artifact_target` for this audience, including input contract, output contract, and failure modes.
...
### domain.os.exec_ok.doc.1.maintainer
...
### domain.os.core.maintainer
- Location: `/specs/05_libraries/domain/os_core.spec.md`
- Summary: Case `LIB-DOMAIN-OS-001-001-DOMAIN-OS-EXEC-OK` for `contract.export`. (maintainer)
- Description:
  Purpose: Documents behavior for `domain.os.exec_ok` for this audience, including input contract, output contract, and failure modes.
...
### domain.path.sorted.doc.1.maintainer
...
### domain.path.core.maintainer
- Location: `/specs/05_libraries/domain/path_core.spec.md`
- Summary: Case `LIB-DOMAIN-PATH-001-001-DOMAIN-PATH-NORMALIZE` for `contract.export`. (maintainer)
- Description:
  Purpose: Documents behavior for `domain.path.sorted` for this audience, including input contract, output contract, and failure modes.
...
### php.is_assoc_projection.doc.1.maintainer
- Location: `/specs/05_libraries/domain/php_core.spec.md`
- Summary: Assert a PHP projection result is associative for maintenance verification.
- Description:
...
### domain.php.core.maintainer
- Location: `/specs/05_libraries/domain/php_core.spec.md`
- Summary: Case `LIB-DOMAIN-PHP-001` for `contract.export`. (maintainer)
- Description:
  Purpose: Documents behavior for `php.is_assoc_projection` for this audience, including input contract, output contract, and failure modes.
...
### domain.process.exec_capture_ex_code.doc.1.maintainer
...
### domain.process.core.maintainer
- Location: `/specs/05_libraries/domain/process_core.spec.md`
- Summary: Case `LIB-DOMAIN-PROCESS-001-001-DOMAIN-PROCESS-EXEC-CAPTURE-EX-CODE` for `contract.export`. (maintainer)
- Description:
  Purpose: Documents behavior for `domain.process.exec_capture_ex_code` for this audience, including input contract, output contract, and failure modes.
...
### py.is_tuple_projection.doc.1.maintainer
...
### domain.repo.walk_matching.doc.1.maintainer
...
### domain.repo.core.maintainer
- Location: `/specs/05_libraries/domain/repo_core.spec.md`
- Summary: Case `LIB-DOMAIN-REPO-001-001-DOMAIN-REPO-WALK-MATCHING` for `contract.export`. (maintainer)
- Description:
  Purpose: Documents behavior for `domain.repo.walk_matching` for this audience, including input contract, output contract, and failure modes.
...
### domain.yaml.stringify.doc.1.maintainer
- Location: `/specs/05_libraries/domain/yaml_core.spec.md`
- Summary: Serialize structured data into canonical YAML text for maintainers.
- Description:
...
### domain.yaml.core.maintainer
- Location: `/specs/05_libraries/domain/yaml_core.spec.md`
- Summary: Case `LIB-DOMAIN-YAML-001-001-DOMAIN-YAML-PARSE-GET-OR` for `contract.export`. (maintainer)
- Description:
  Purpose: Documents behavior for `domain.yaml.stringify` for this audience, including input contract, output contract, and failure modes.
...
### path.path.core.maintainer
- Location: `/specs/05_libraries/path/path_core.spec.md`
- Summary: Case `LIB-PATH-001-001-PATH-NORMALIZE-SLASHES` for `contract.export`. (maintainer)
- Description:
  Purpose: Documents behavior for `path.matches` for this audience, including input contract, output contract, and failure modes.
...
### policy.violation_count_is.doc.1.maintainer
...
### policy.metric_non_increase.doc.1.maintainer
...
### policy.policy.metrics.maintainer
- Location: `/specs/05_libraries/policy/policy_metrics.spec.md`
- Summary: Case `LIB-POLICY-002-001-POLICY-METRIC-NON-DECREASE` for `contract.export`. (maintainer)
- Description:
  Purpose: Documents behavior for `policy.metric_non_increase` for this audience, including input contract, output contract, and failure modes.
...
### std.string.contains.doc.1.maintainer
...
- Description:
  Purpose: Use this symbol for maintaining deterministic semantics during upgrades.
...
### std.string.starts_with.doc.1.maintainer
- Location: `/specs/05_libraries/domain/stdlib_string_reference.spec.md`
- Summary: Maintain stable prefix behavior across version upgrades.
- Description:
  Purpose: Use this predicate while maintaining compatibility expectations for prefix checks.
...
### std.string.ends_with.doc.1.maintainer
- Location: `/specs/05_libraries/domain/stdlib_string_reference.spec.md`
- Summary: Monitor suffix behavior through lifecycle changes.
- Description:
  Purpose: Use this predicate while monitoring release impact of trailing-match behavior.
