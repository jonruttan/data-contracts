...
- Description:
  contract docs id intentionally omitted for governance and policy review before policy acceptance.
  
  This entry is tailored for governance. Inputs are the contract parameters for this symbol, and output is the return payload from the underlying assertion/export.
...
- Description:
  missing status for governance and policy review before policy acceptance.
...
- Description:
  invalid docs type for governance and policy review before policy acceptance.
...
- Description:
  docs entry one for governance and policy review before policy acceptance.
...
- Description:
  docs entry two for governance and policy review before policy acceptance.
...
- Description:
  docs entry with unknown key for governance and policy review before policy acceptance.
...
- Description:
  schema export validation case for governance and policy review before policy acceptance.
...
- Description:
  schema export invalid imports case for governance and policy review before policy acceptance.
...
- Description:
  Contract export for `conf.json_type_is` for policy, compliance, and governance decisions.
  
  for governance and policy oversight when approving or auditing contract surface.
...
- Description:
  Contract export for `bad.path.symbol` for policy, compliance, and governance decisions.
...
- Description:
  Contract export for `domain.artifact.write_yaml` for policy, compliance, and governance decisions.
...
- Location: `harness.config.exports[1].docs[]`
- Summary: Contract export for `domain.conformance.validate_report_errors`. (governance)
- Description:
  Contract export for `domain.conformance.validate_report_errors` for policy, compliance, and governance decisions.
...
- Description:
  Contract export for `domain.contract_set.applies_to_runners` for policy, compliance, and governance decisions.
...
- Description:
  Contract export for `domain.fs.sort_spec_files` for policy, compliance, and governance decisions.
...
- Description:
  Contract export for `domain.http.step_status_is` for policy, compliance, and governance decisions.
...
- Description:
  Contract export for `domain.job.scan_bundle_has_result` for policy, compliance, and governance decisions.
...
- Description:
  Contract export for `make.has_target` for policy, compliance, and governance decisions.
...
- Description:
  Contract export for `domain.markdown.tokens_all_present` for policy, compliance, and governance decisions.
...
- Description:
  Contract export for `domain.meta.has_artifact_target` for policy, compliance, and governance decisions.
...
- Description:
  Contract export for `domain.os.exec_ok` for policy, compliance, and governance decisions.
...
- Description:
  Contract export for `domain.path.sorted` for policy, compliance, and governance decisions.
...
- Location: `harness.config.exports[1].docs[]`
- Summary: Contract export for `php.is_assoc_projection`. (governance)
- Description:
  Contract export for `php.is_assoc_projection` for policy, compliance, and governance decisions.
...
- Description:
  Contract export for `domain.process.exec_capture_ex_code` for policy, compliance, and governance decisions.
...
- Description:
  Contract export for `py.is_tuple_projection` for policy, compliance, and governance decisions.
...
- Description:
  Contract export for `domain.repo.walk_matching` for policy, compliance, and governance decisions.
...
- Location: `harness.config.exports[1].docs[]`
- Summary: Contract export for `domain.yaml.stringify`. (governance)
- Description:
  Contract export for `domain.yaml.stringify` for policy, compliance, and governance decisions.
...
- Location: `harness.config.exports[1].docs[]`
- Summary: Contract export for `path.matches`. (governance)
- Description:
  Contract export for `path.matches` for policy, compliance, and governance decisions.
...
- Description:
  Contract export for `policy.violation_count_is` for policy, compliance, and governance decisions.
...
- Description:
  Contract export for `policy.metric_non_increase` for policy, compliance, and governance decisions.
