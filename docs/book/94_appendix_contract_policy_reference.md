...
| `HARNESS_ON_FAIL_HOOK_ON_FIRST_FAILURE_REQUIRED` | `MUST` | `runtime` | `when.fail` | 2 | `active` |
| `HARNESS_ON_HOOKS_SCHEMA_VALID` | `MUST` | `runtime` | `when` | 3 | `active` |
| `HARNESS_ON_HOOK_FAILURE_FAILFAST_REQUIRED` | `MUST` | `runtime` | `when` | 2 | `active` |
