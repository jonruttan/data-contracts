...
| `CHAIN_EXPORTS_FROM_KEY_REQUIRED` | `MUST` | `schema` | `harness.chain.steps.imports[*].from` | 4 | `active` |
| `CHAIN_EXPORTS_LIST_ONLY_REQUIRED` | `MUST` | `schema` | `harness.chain.steps.imports` | 5 | `active` |
...
| `CHAIN_LEGACY_FROM_TARGET_FORBIDDEN` | `MUST_NOT` | `schema` | `harness.chain.steps.imports[*].from_target` | 3 | `active` |
| `CHAIN_LIBRARY_SYMBOL_EXPORTS_VALID` | `MUST` | `implementation` | `harness.chain.steps.imports[*]` | 4 | `active` |
