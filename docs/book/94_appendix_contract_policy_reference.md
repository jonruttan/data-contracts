...
| `CHAIN_EXPORTS_EXPLICIT_REQUIRED` | `MUST` | `implementation` | `harness.exports` | 2 | `active` |
| `CHAIN_EXPORTS_FROM_KEY_REQUIRED` | `MUST` | `schema` | `harness.exports[*].from` | 4 | `active` |
...
| `NORMALIZATION_MAPPING_AST_ONLY` | `MUST` | `schema` | `evaluate_and_evaluate_yaml_authoring` | 4 | `active` |
...
| `RUNTIME_PYTHON_DEPENDENCY_EVIDENCE_REPORTED` | `MUST` | `governance` | `runtime.compatibility_python_lane_dependency.metric_report` | 1 | `active` |
| `RUNTIME_PYTHON_DEPENDENCY_NON_REGRESSION_REQUIRED` | `MUST` | `governance` | `runtime.compatibility_python_lane_dependency.metric_non_regression` | 3 | `active` |
| `RUNTIME_PYTHON_USAGE_SCOPED_TO_PYTHON_RUNNER` | `MUST` | `governance` | `runtime.compatibility_python_lane_usage.scope` | 2 | `active` |
...
| `RUNTIME_RUST_ADAPTER_TARGET_FALLBACK_REQUIRED` | `MUST` | `governance` | `runtime.required_lane_adapter.target_selection` | 1 | `active` |
| `RUNTIME_RUST_ADAPTER_TRANSITIVE_NO_PYTHON` | `MUST` | `governance` | `runtime.required_lane_adapter.transitive_path` | 2 | `active` |
...
| `RUST_PRIMARY_ADAPTER_EXEC_SMOKE_REQUIRED` | `MUST` | `governance` | `runtime.required_lane_primary.adapter_exec` | 2 | `active` |
| `RUST_PRIMARY_DOCS_ADOPTION_SYNC` | `SHOULD` | `docs` | `docs.rust_primary.adoption` | 2 | `active` |
| `RUST_PRIMARY_GATE_PATH_REQUIRED` | `MUST` | `governance` | `runtime.required_lane_primary.ci_lane` | 2 | `active` |
| `RUST_PRIMARY_INTERFACE_STABILITY_REQUIRED` | `MUST` | `governance` | `runtime.required_lane_primary.interface_stability` | 2 | `active` |
| `RUST_PRIMARY_NO_PYTHON_GATE_DEPENDENCY` | `MUST` | `governance` | `runtime.required_lane_primary.gate_dependency` | 2 | `active` |
| `RUST_PRIMARY_SHARED_CAPABILITY_PARITY_REQUIRED` | `MUST` | `governance` | `runtime.required_lane_primary.parity` | 2 | `active` |
| `RUST_PRIMARY_SUBCOMMAND_PARITY_REQUIRED` | `MUST` | `governance` | `runtime.required_lane_primary.interface_parity` | 2 | `active` |
...
| `WHEN_CLASS_HOOK_ORDER_REQUIRED` | `MUST` | `runtime` | `when.class_hooks` | 2 | `active` |
| `WHEN_COMPLETE_HOOK_AFTER_FINAL_CLASS_HOOK_REQUIRED` | `MUST` | `runtime` | `when.complete` | 2 | `active` |
| `WHEN_FAIL_HOOK_ON_FIRST_FAILURE_REQUIRED` | `MUST` | `runtime` | `when.fail` | 2 | `active` |
| `WHEN_HOOKS_SCHEMA_VALID` | `MUST` | `runtime` | `when` | 3 | `active` |
| `WHEN_HOOK_FAILURE_FAILFAST_REQUIRED` | `MUST` | `runtime` | `when` | 2 | `active` |
