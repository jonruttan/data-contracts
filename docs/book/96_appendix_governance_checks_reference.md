...
| `runtime.compatibility_python_lane_bin_resolver_sync` | 0 | false |
| `runtime.compatibility_python_lane_dependency_metric` | 0 | false |
| `runtime.compatibility_python_lane_dependency_non_regression` | 0 | false |
| `runtime.compatibility_python_lane_lane_explicit_opt_in` | 0 | false |
...
| `runtime.required_lane_adapter_exec_smoke` | 0 | false |
| `runtime.required_lane_adapter_no_delegate` | 0 | false |
| `runtime.required_lane_adapter_no_python_exec` | 0 | false |
| `runtime.required_lane_adapter_subcommand_parity` | 0 | false |
| `runtime.required_lane_adapter_transitive_no_python` | 0 | false |
| `runtime.required_lane_only_prepush_required` | 0 | false |
