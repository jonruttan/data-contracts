...
|---|---|---|---|---|---|---|
| `API_HTTP_CORS_PRELIGHT_AND_ACTUAL_SUPPORTED` | `docs/spec/contract/policy_v1.yaml#API_HTTP_CORS_PRELIGHT_AND_ACTUAL_SUPPORTED` | 2 | 1 | 0 | 1 | 2 |
| `API_HTTP_DETERMINISTIC_DEFAULT_REQUIRED` | `docs/spec/contract/policy_v1.yaml#API_HTTP_DETERMINISTIC_DEFAULT_REQUIRED` | 1 | 1 | 0 | 1 | 1 |
| `API_HTTP_LIVE_MODE_EXPLICIT_OPT_IN_REQUIRED` | `docs/spec/contract/policy_v1.yaml#API_HTTP_LIVE_MODE_EXPLICIT_OPT_IN_REQUIRED` | 1 | 1 | 0 | 2 | 2 |
| `API_HTTP_OAUTH_ENV_REF_ONLY_REQUIRED` | `docs/spec/contract/policy_v1.yaml#API_HTTP_OAUTH_ENV_REF_ONLY_REQUIRED` | 1 | 1 | 0 | 2 | 2 |
| `API_HTTP_OAUTH_HARNESS_PROFILE_SUPPORTED` | `docs/spec/contract/policy_v1.yaml#API_HTTP_OAUTH_HARNESS_PROFILE_SUPPORTED` | 2 | 1 | 0 | 1 | 1 |
| `API_HTTP_OAUTH_SECRET_REDACTION_REQUIRED` | `docs/spec/contract/policy_v1.yaml#API_HTTP_OAUTH_SECRET_REDACTION_REQUIRED` | 1 | 1 | 0 | 1 | 1 |
| `API_HTTP_PY_PHP_BEHAVIOR_PARITY_REQUIRED` | `docs/spec/contract/policy_v1.yaml#API_HTTP_PY_PHP_BEHAVIOR_PARITY_REQUIRED` | 1 | 1 | 0 | 2 | 2 |
| `API_HTTP_SCENARIO_DETERMINISTIC_LIFECYCLE_REQUIRED` | `docs/spec/contract/policy_v1.yaml#API_HTTP_SCENARIO_DETERMINISTIC_LIFECYCLE_REQUIRED` | 1 | 1 | 0 | 1 | 1 |
| `API_HTTP_SCENARIO_ROUNDTRIP_SUPPORTED` | `docs/spec/contract/policy_v1.yaml#API_HTTP_SCENARIO_ROUNDTRIP_SUPPORTED` | 1 | 1 | 0 | 1 | 2 |
| `API_HTTP_TUTORIAL_COVERAGE_REQUIRED` | `docs/spec/contract/policy_v1.yaml#API_HTTP_TUTORIAL_COVERAGE_REQUIRED` | 2 | 0 | 0 | 1 | 1 |
| `API_HTTP_VERB_SUITE_REQUIRED` | `docs/spec/contract/policy_v1.yaml#API_HTTP_VERB_SUITE_REQUIRED` | 1 | 1 | 0 | 1 | 2 |
| `ASSERT_ADAPTER_PROJECTION_SYNC_REQUIRED` | `docs/spec/contract/policy_v1.yaml#ASSERT_ADAPTER_PROJECTION_SYNC_REQUIRED` | 1 | 1 | 0 | 1 | 7 |
| `ASSERT_BLOCK_DECISION_AUTHORITY_REQUIRED` | `docs/spec/contract/policy_v1.yaml#ASSERT_BLOCK_DECISION_AUTHORITY_REQUIRED` | 2 | 1 | 0 | 1 | 1 |
| `ASSERT_COMPILER_SCHEMA_MATRIX_SYNC` | `docs/spec/contract/policy_v1.yaml#ASSERT_COMPILER_SCHEMA_MATRIX_SYNC` | 3 | 1 | 0 | 2 | 3 |
| `ASSERT_CONTEXT_PROJECTION_CONTRACT_REQUIRED` | `docs/spec/contract/policy_v1.yaml#ASSERT_CONTEXT_PROJECTION_CONTRACT_REQUIRED` | 2 | 2 | 0 | 1 | 5 |
| `ASSERT_DOMAIN_ASSERTIONS_LIBRARY_BACKED` | `docs/spec/contract/policy_v1.yaml#ASSERT_DOMAIN_ASSERTIONS_LIBRARY_BACKED` | 2 | 1 | 0 | 1 | 7 |
| `ASSERT_HEALTH_GLOBAL_AND_PER_CASE_POLICY` | `docs/spec/contract/policy_v1.yaml#ASSERT_HEALTH_GLOBAL_AND_PER_CASE_POLICY` | 2 | 1 | 0 | 3 | 3 |
| `ASSERT_HEALTH_MODE_VALID_VALUES` | `docs/spec/contract/policy_v1.yaml#ASSERT_HEALTH_MODE_VALID_VALUES` | 1 | 1 | 0 | 1 | 1 |
| `ASSERT_HEALTH_NON_PORTABLE_REGEX_DIAGNOSTIC` | `docs/spec/contract/policy_v1.yaml#ASSERT_HEALTH_NON_PORTABLE_REGEX_DIAGNOSTIC` | 3 | 1 | 0 | 2 | 3 |
| `ASSERT_HEALTH_REDUNDANT_BRANCH_DIAGNOSTIC` | `docs/spec/contract/policy_v1.yaml#ASSERT_HEALTH_REDUNDANT_BRANCH_DIAGNOSTIC` | 2 | 1 | 0 | 2 | 2 |
| `ASSERT_NO_NON_JSON_EVALUATOR_TYPES` | `docs/spec/contract/policy_v1.yaml#ASSERT_NO_NON_JSON_EVALUATOR_TYPES` | 2 | 1 | 0 | 1 | 3 |
| `ASSERT_SUBJECT_PROFILE_JSON_CORE_ONLY` | `docs/spec/contract/policy_v1.yaml#ASSERT_SUBJECT_PROFILE_JSON_CORE_ONLY` | 2 | 1 | 0 | 1 | 3 |
| `ASSERT_SUGAR_OPERATORS_COMPILE_ONLY` | `docs/spec/contract/policy_v1.yaml#ASSERT_SUGAR_OPERATORS_COMPILE_ONLY` | 3 | 1 | 0 | 3 | 4 |
| `ASSERT_TARGET_CONTRACT_SUBJECT_DRIVEN` | `docs/spec/contract/policy_v1.yaml#ASSERT_TARGET_CONTRACT_SUBJECT_DRIVEN` | 4 | 1 | 0 | 1 | 2 |
| `ASSERT_UNIVERSAL_CORE_EVALUATE_ONLY` | `docs/spec/contract/policy_v1.yaml#ASSERT_UNIVERSAL_CORE_EVALUATE_ONLY` | 3 | 1 | 0 | 2 | 3 |
| `CASE_CONTRACT_BLOCK_REQUIRED` | `docs/spec/contract/policy_v1.yaml#CASE_CONTRACT_BLOCK_REQUIRED` | 1 | 1 | 0 | 1 | 2 |
...
| `CHAIN_EXPORTS_LIST_ONLY_REQUIRED` | `docs/spec/contract/policy_v1.yaml#CHAIN_EXPORTS_LIST_ONLY_REQUIRED` | 1 | 1 | 0 | 2 | 3 |
...
| `CLI_RUN_CONFORMANCE_EXPLICIT_ENTRYPOINT` | `docs/spec/contract/policy_v1.yaml#CLI_RUN_CONFORMANCE_EXPLICIT_ENTRYPOINT` | 2 | 1 | 0 | 2 | 0 |
| `CLI_RUN_CONFORMANCE_NO_ENV_DEPENDENCY` | `docs/spec/contract/policy_v1.yaml#CLI_RUN_CONFORMANCE_NO_ENV_DEPENDENCY` | 2 | 1 | 0 | 2 | 0 |
| `CLI_RUN_ENTRYPOINT_REQUIRED` | `docs/spec/contract/policy_v1.yaml#CLI_RUN_ENTRYPOINT_REQUIRED` | 1 | 1 | 0 | 2 | 1 |
...
| `CONFORMANCE_SPEC_LANG_FIXTURE_LIBRARY_USAGE_REQUIRED` | `docs/spec/contract/policy_v1.yaml#CONFORMANCE_SPEC_LANG_FIXTURE_LIBRARY_USAGE_REQUIRED` | 2 | 1 | 0 | 1 | 2 |
...
| `CONTRACT_JOB_FAIL_COMPLETE_HOOK_PATTERN_REQUIRED` | `docs/spec/contract/policy_v1.yaml#CONTRACT_JOB_FAIL_COMPLETE_HOOK_PATTERN_REQUIRED` | 1 | 1 | 0 | 1 | 2 |
...
| `LIBRARY_DOMAIN_INDEX_SYNC` | `docs/spec/contract/policy_v1.yaml#LIBRARY_DOMAIN_INDEX_SYNC` | 2 | 1 | 0 | 1 | 2 |
...
| `LIBRARY_VERB_FIRST_SCHEMA_KEYS_REQUIRED` | `docs/spec/contract/policy_v1.yaml#LIBRARY_VERB_FIRST_SCHEMA_KEYS_REQUIRED` | 1 | 2 | 0 | 1 | 1 |
| `META_JSON_TARGET_REQUIRED` | `docs/spec/contract/policy_v1.yaml#META_JSON_TARGET_REQUIRED` | 1 | 1 | 0 | 1 | 5 |
...
| `NORMALIZATION_MAPPING_AST_ONLY` | `docs/spec/contract/policy_v1.yaml#NORMALIZATION_MAPPING_AST_ONLY` | 2 | 2 | 0 | 2 | 3 |
| `NORMALIZATION_PROFILE_DEFINED` | `docs/spec/contract/policy_v1.yaml#NORMALIZATION_PROFILE_DEFINED` | 2 | 1 | 0 | 1 | 2 |
| `NORMALIZATION_VIRTUAL_ROOT_PATHS_ONLY` | `docs/spec/contract/policy_v1.yaml#NORMALIZATION_VIRTUAL_ROOT_PATHS_ONLY` | 2 | 1 | 0 | 1 | 2 |
...
| `PORTABLE_SPEC_DETERMINISM_BY_CONSTRUCTION` | `docs/spec/contract/policy_v1.yaml#PORTABLE_SPEC_DETERMINISM_BY_CONSTRUCTION` | 2 | 1 | 0 | 1 | 1 |
...
| `RUNTIME_RUST_ADAPTER_TARGET_FALLBACK_REQUIRED` | `docs/spec/contract/policy_v1.yaml#RUNTIME_RUST_ADAPTER_TARGET_FALLBACK_REQUIRED` | 1 | 0 | 0 | 2 | 1 |
...
| `SCHEMA_DOCS_GENERATED_FROM_REGISTRY_REQUIRED` | `docs/spec/contract/policy_v1.yaml#SCHEMA_DOCS_GENERATED_FROM_REGISTRY_REQUIRED` | 1 | 1 | 0 | 1 | 1 |
| `SCHEMA_PROSE_ONLY_RULES_FORBIDDEN` | `docs/spec/contract/policy_v1.yaml#SCHEMA_PROSE_ONLY_RULES_FORBIDDEN` | 1 | 1 | 0 | 1 | 1 |
| `SCHEMA_REGISTRY_SOURCE_OF_TRUTH_REQUIRED` | `docs/spec/contract/policy_v1.yaml#SCHEMA_REGISTRY_SOURCE_OF_TRUTH_REQUIRED` | 1 | 2 | 0 | 1 | 2 |
| `SCHEMA_REGISTRY_VALIDATION_REQUIRED` | `docs/spec/contract/policy_v1.yaml#SCHEMA_REGISTRY_VALIDATION_REQUIRED` | 1 | 1 | 0 | 1 | 2 |
| `SCHEMA_TYPE_PROFILE_COVERAGE_REQUIRED` | `docs/spec/contract/policy_v1.yaml#SCHEMA_TYPE_PROFILE_COVERAGE_REQUIRED` | 1 | 4 | 0 | 1 | 2 |
| `SCHEMA_UNKNOWN_KEYS_HARD_FAIL` | `docs/spec/contract/policy_v1.yaml#SCHEMA_UNKNOWN_KEYS_HARD_FAIL` | 1 | 1 | 0 | 1 | 1 |
...
| `SPEC_DOMAIN_INDEX_SYNC` | `docs/spec/contract/policy_v1.yaml#SPEC_DOMAIN_INDEX_SYNC` | 1 | 1 | 0 | 1 | 2 |
...
| `SPEC_LANG_COLLECTION_FORMS_CONTRACTED` | `docs/spec/contract/policy_v1.yaml#SPEC_LANG_COLLECTION_FORMS_CONTRACTED` | 1 | 1 | 0 | 1 | 2 |
| `SPEC_LANG_CURRY_ALL_BUILTINS` | `docs/spec/contract/policy_v1.yaml#SPEC_LANG_CURRY_ALL_BUILTINS` | 1 | 1 | 0 | 1 | 3 |
| `SPEC_LANG_DEEP_EQUALITY_DETERMINISTIC` | `docs/spec/contract/policy_v1.yaml#SPEC_LANG_DEEP_EQUALITY_DETERMINISTIC` | 1 | 1 | 0 | 1 | 2 |
| `SPEC_LANG_ERROR_CLASSIFICATION` | `docs/spec/contract/policy_v1.yaml#SPEC_LANG_ERROR_CLASSIFICATION` | 2 | 1 | 0 | 2 | 3 |
| `SPEC_LANG_EVALUATE_LIST_SHAPE` | `docs/spec/contract/policy_v1.yaml#SPEC_LANG_EVALUATE_LIST_SHAPE` | 2 | 1 | 0 | 2 | 4 |
| `SPEC_LANG_EVAL_BUDGETS_REQUIRED` | `docs/spec/contract/policy_v1.yaml#SPEC_LANG_EVAL_BUDGETS_REQUIRED` | 1 | 1 | 0 | 2 | 3 |
...
| `SPEC_LANG_PROPER_TCO_REQUIRED` | `docs/spec/contract/policy_v1.yaml#SPEC_LANG_PROPER_TCO_REQUIRED` | 1 | 1 | 0 | 1 | 3 |
| `SPEC_LANG_PURE_EVALUATOR` | `docs/spec/contract/policy_v1.yaml#SPEC_LANG_PURE_EVALUATOR` | 2 | 1 | 0 | 1 | 3 |
| `SPEC_LANG_PURE_NO_EFFECT_BUILTINS` | `docs/spec/contract/policy_v1.yaml#SPEC_LANG_PURE_NO_EFFECT_BUILTINS` | 2 | 1 | 0 | 2 | 4 |
| `SPEC_LANG_SET_ALGEBRA_PARITY` | `docs/spec/contract/policy_v1.yaml#SPEC_LANG_SET_ALGEBRA_PARITY` | 1 | 1 | 0 | 2 | 3 |
| `SPEC_LANG_STDLIB_CONFORMANCE_COVERAGE_REQUIRED` | `docs/spec/contract/policy_v1.yaml#SPEC_LANG_STDLIB_CONFORMANCE_COVERAGE_REQUIRED` | 2 | 1 | 0 | 1 | 2 |
| `SPEC_LANG_STDLIB_DOCS_SYNC_REQUIRED` | `docs/spec/contract/policy_v1.yaml#SPEC_LANG_STDLIB_DOCS_SYNC_REQUIRED` | 2 | 2 | 0 | 1 | 3 |
| `SPEC_LANG_STDLIB_PROFILE_COMPLETE` | `docs/spec/contract/policy_v1.yaml#SPEC_LANG_STDLIB_PROFILE_COMPLETE` | 1 | 1 | 0 | 1 | 3 |
...
| `SPEC_LAYOUT_DOMAIN_TREES` | `docs/spec/contract/policy_v1.yaml#SPEC_LAYOUT_DOMAIN_TREES` | 2 | 1 | 0 | 1 | 2 |
